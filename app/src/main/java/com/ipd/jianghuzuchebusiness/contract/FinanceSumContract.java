 ...
 * Time ： 2019/4/2.
 */
public interface FinanceSumContract {

    interface View extends BaseView {
        //不同的Bean单独处理
        void resultFinanceSum(FinanceSumBean data);

        <T> ObservableTransformer<T, T> bindLifecycle();
    }

    abstract class Presenter extends BasePresenter<View> {
        public abstract void getFinanceSum(TreeMap<String, String> map, boolean isDialog, boolean cancelable);
    }
}