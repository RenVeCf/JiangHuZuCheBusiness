 ...
 * Time ： 2019/5/10.
 */
public class MultipleOrderFragment extends BaseFragment<MultipleOrderContract.View, MultipleOrderContract.Presenter> implements MultipleOrderContract.View, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void init() {
        ...
        if (multipleFmType == 4) {
            ...
            for (int i = 0; i < repairTypeBean.get(statusPosition).getAppRepairs().size(); i++) {
    ...
    public void initListener() {
        srlMultipleOrder.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        if (multipleFmType == 3 || multipleFmType == 4) {
            ...
            repairOrderAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                ...
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    startActivityForResult(new Intent(getActivity(), MaintenanceOrderDetailsActivity.class).putExtra("order_id", repairOrderListBean.get(position).getOrderId()).putExtra("repairs", repairOrderListBean.get(position).getRepairs()).putExtra("charges", repairOrderListBean.get(position).getCharges()), REQUEST_CODE_96);
                }
            });
            ...
            getCarHistoryOrderAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                    startActivity(new Intent(getActivity(), OrderDetailsActivity.class).putExtra("type", multipleFmType).putExtra("order_id", getCarOrderBean.get(position).getOrderId() + "").putExtra("status_get", getCarOrderBean.get(position).getTakeStatus()).putExtra("status_out", getCarOrderBean.get(position).getStoreStatus()));
                }
            });
                        ...
                        case R.id.bt_order_type_end:
                            if (multipleFmType == 0) {
                                if (getCarOrderBean.get(position).getTakeStatus() == 2)
                                    startActivity(new Intent(getActivity(), SelectCarActivity.class).putExtra("order_id", getCarOrderBean.get(position).getOrderId() + ""));
                                else
            ...
            case 1:
                ...
                switch (j) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        carReturnOrderMap.put("status", "4");
                        break;
                    case 3:
    ...
    public void Search(String content, int positions) {
...
//                getCarOrderMap.put("userId", SPUtil.get(getActivity(), USER_ID, "") + "");
//                getCarOrderMap.put("telPhone", content);
//                LogUtils.i("rmy", "positions = " + positions);
//                switch (positions) {
//                    case 0:
//                        getCarOrderMap.put("status", "1");
//                        break;
