...
import com.ipd.jianghuzuchebusiness.model.OrderDetailsModel;
...
public class OrderDetailsPresenter extends OrderDetailsContract.Presenter {
    ...
    @Override
    public void getReturnOrderDesc(TreeMap<String, String> map, boolean isDialog, boolean cancelable) {
        model.getReturnOrderDesc(context, map, isDialog, cancelable, getView().bindLifecycle(), new ObserverResponseListener() {
            @Override
            public void onNext(Object o) {
                //这一步是必须的，判断view是否已经被销毁
                if (getView() != null) {
                    getView().resultReturnOrderDesc((ReturnOrderDescBean) o);
                }
            }
