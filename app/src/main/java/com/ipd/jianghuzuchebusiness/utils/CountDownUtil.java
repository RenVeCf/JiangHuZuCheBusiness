...
/**
 * Created by Mengyang on 2018/8/22
 */
        ...
        if (mTextView != null) {
            if (usable) {
                ...
                if (!mTextView.isClickable()) {
                    ...
                    mTextView.setBackgroundResource(R.drawable.bg_verification_select);
                }
            } else {
                //不可用
                if (mTextView.isClickable()) {
                    ...
                    mTextView.setBackgroundResource(R.drawable.bg_verification);
                }
